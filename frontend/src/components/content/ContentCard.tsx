...
import { Play, Eye, Heart, Clock, Zap, Crown, Image as ImageIcon, Radio } from 'lucide-react';
    ...
    return (
      ...
      >
        <div className="relative w-40 aspect-video rounded-lg overflow-hidden flex-shrink-0">
          ...
          {/* Top-right: VR badge */}
          {isVR && (
            <Badge className="absolute top-1 right-1 bg-background/90 text-foreground text-[10px] px-1.5 py-0 font-bold">
              VR
            </Badge>
          )}
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video rounded-xl overflow-hidden bg-muted">
        ...
        {/* Top-right badge: VR indicator */}
        {isVR && (
          <Badge className="absolute top-2 right-2 bg-background/90 backdrop-blur-sm text-foreground font-bold shadow-md px-1.5 py-0.5 text-[10px]">
            VR
          </Badge>
        )}
